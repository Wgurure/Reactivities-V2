...
export default function ActivitesDashboard({activities, cancelSelectActivity, selectedActivity, selectActivity, openForm, closeForm, editMode, submitForm, deleteActivity} :Props) {
  return (
    <Grid2 container>
        <Grid2 size={7}>
